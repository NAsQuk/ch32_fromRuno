// $Id: mios32_iic.c 1243 2011-07-06 18:19:24Z tk $
//! \defgroup MIOS32_IIC
//!
...
#define MIOS32_IIC0_SCL_PIN     GPIO_Pin_6
#define MIOS32_IIC0_SDA_PORT    GPIOB
#define MIOS32_IIC0_SDA_PIN     GPIO_Pin_7

#define MIOS32_IIC1_SCL_PORT    GPIOB
#define MIOS32_IIC1_SCL_PIN     GPIO_Pin_10
#define MIOS32_IIC1_SDA_PORT    GPIOB
#define MIOS32_IIC1_SDA_PIN     GPIO_Pin_11
...
static void MIOS32_IIC_InitPeripheral();
...
//! (MIOS32_IIC_TransferBegin() has to be called again)
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_IIC_Transfer(mios32_iic_transfer_t transfer, u8 address, u8 *buffer, u16 len)
{
  u8 iic_port = 0;
  iic_rec_t *iicx = &iic_rec[iic_port];// simplify addressing of record
  s32 error;
