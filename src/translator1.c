...
void DoProgram() {
	...
	for (int i = 0; i < 8; i++) {
		if (GetChannelBitRepare(i, RAM.CommonCommand) == 1) {
			if (GetChannelBitRepare(i, RAM.OutputCommand) == 1)
				continue;
			SetChannelBitSignal(i, RAM.LocalCommand,
					GetChannelBitSignal(i, RAM.CommonCommand));
			SetChannelBitDirect(i, RAM.LocalCommand,
					GetChannelBitDirect(i, RAM.CommonCommand));
			SetChannelBitReserv(i, RAM.LocalCommand,
					GetChannelBitReserv(i, RAM.CommonCommand));
	...
	for (int i = 0; i < 8; i++) {
		...
		SetChannelBitRepare(i, RAM.OutputCommand,
				GetChannelBitRepare(i, RAM.LocalCommand));
		SetChannelBitReserv(i, RAM.OutputCommand,
				GetChannelBitReserv(i, RAM.LocalCommand));
