...
/* Modified by Martin Thomas HD added by Baron
...
#endif /* VECT_TAB_RAM */
{
    ...
    0,                          /* Reserved */
    0,                          /* Reserved */
    vPortSVCHandler,// SVC_Handler,                /* SVCall Handler */
    DebugMon_Handler,           /* Debug Monitor Handler */
    0,                          /* Reserved */
    xPortPendSVHandler,// PendSV_Handler,             /* PendSV Handler */
    xPortSysTickHandler,// SysTick_Handler,            /* SysTick Handler */
